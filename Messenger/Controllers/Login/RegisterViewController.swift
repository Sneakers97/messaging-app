...
//
//
//        facebookregisterButton.frame = CGRect(x: 30,
//                                   y: registerButton.bottom+10,
//                                   width: scrollView.width-60,
//                                   height: 52)
//
//        googleregisterButton.frame = CGRect(x: 30,
//                                   y: facebookregisterButton.bottom+10,
//                                   width: scrollView.width-60,
//                                   height: 52)
    }
    ...
    @objc private func registerButtonTapped() {
        ...
        DatabaseManager.shared.userExists(with: email, completion: { [weak self] exists in
            ...
            guard !exists else {
                // user already exists
                strongSelf.alertUserLoginError(message: "Looks like an email account for that email already exists.")
                return
            }
            FirebaseAuth.Auth.auth().createUser(withEmail: email, password: password, completion: { authResult, error in
                ...
                DatabaseManager.shared.insertUser(with: chatUser, completion: { success in
                    if success {
                        ...
                        print("I should be capturing the png data here")
                        print(image)
                        print(data)
